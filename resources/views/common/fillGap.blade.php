...
<html lang="en">
  ...
  <body>
    ...
    <section class="sortableSection py-5">
...
<!--  </head>-->
<!--  <body class="" style="background: rgb(235, 231, 231); font-family: 'Poppins', sans-serif">-->
    <!---content------------------------------------------------------------------------>    
...
<!--    <div class="draggableSection my-5">-->
<!--      <div class="container">-->
<!--        <div class="row">-->
<!--          <div class="text-center"><h1> Example </h1></div>-->
<!--          <div> -->
<!--            <h4>-->
<!--            Bangladesh, to the east of India on the Bay of Bengal, is a South Asian country marked by lush greenery and many waterways. -->
<!--            Its Padma (Ganges), Meghna and Jamuna rivers create fertile plains, -->
...
<!--        <div class="row text-center">-->
<!--          <div class="text-center"><h1> Practice </h1></div>-->
<!--          <div id="bengal"><p>Bengal</p></div>-->
<!--          <div id="padma"><p>Padma</p></div>-->
<!--          <div id="sundarbans"><p>Sundarbans</p></div>-->
<!--          <div id="india"><p>India</p></div>-->
...
<!--          accept: "#india",-->
<!--          drop: function (event, ui) {-->
<!--            $(this).find("p").html("___").css("background-color","#66ff66");-->
<!--          },-->
<!--        });-->
<!--        $("#droppable2").droppable({-->
<!--          accept: "#bengal",-->
