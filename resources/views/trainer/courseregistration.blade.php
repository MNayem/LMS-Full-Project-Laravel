...
<form id="regForm" method="post" enctype="multipart/form-data" action="{{ route('course.store') }}" class="form-control">
@csrf
...
<div class="tab">Others:
 ...
 <div class="col-md-6 mt-md-0 mt-3"> <label>Difficulty</label>
                <div class="d-flex align-items-center mt-2"> <select id="difficulty" name="difficulty" oninput="this.className = ''" required>
