...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 ...
 <style type="text/css">
        ...
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&display=swap');
            ...
            .b_footer .total_que span{
                display: flex;
                user-select: none;
            }
            
            .b_footer .total_que span p{
                font-weight: 500;
                padding: 0 5px;
            }
            
            .b_footer .total_que span p:first-child{
                padding-left: 0px;
            }
            ...
            .b_footer button:hover{
                background: #0263ca;
            }
            
            .b_footer button.show{
                opacity: 1;
                pointer-events: auto;
                transform: scale(1);
            }
...
<section class="my-5 py-5" style="height:40vh;">
            <aside>
              <form action="">
                  @csrf
                  <div class="input-group">
                      <div class="form-outline">
                        ...
                        <a href="#" class="btn btn-primary" style="width: 100%; margin-top: 3px; font-size: 12px;"><i class="fas fa-search">&nbsp;Search Here</i></a>
                          <a href="#" class="btn btn-info" style="width: 100%; margin-top: 180px; font-size: 12px;"><i class="fa fa-id-card" aria-hidden="true">&nbsp;Get Report</i></a>
                  </div>
                </div><br>
              </form>
                <!--<h2 style="margin-bottom: 100px; margin-top: 120px;"><a href = "/sampletestmath">Take A Sample Test</a></h2><hr>
                <h2 style="margin-top: 120px;"><a href = "#">Report</a></h2><hr>-->
            </aside>
        <center>
           <!--<h5>Quiz on Important Math Topics</h5>
    		...
    		<div id="results"></div>-->
    		 ...
    		 <!-- start Quiz button -->
    <div class="start_btn"><button style="background-color:#5FCF80;color:white;">Start Quiz</button></div>
    ...
    <script>
        ...
        const next_btn = document.querySelector(".b_footer .next_btn");
        const bottom_ques_counter = document.querySelector(".b_footer .total_que");
